...
<body>
    <div class="container py-5">
        <div class="row g-5">
                ...
                <div class="hero-section animate-float">
                    ...
                    <div class="hero-content">
                        ...
                        <p class="lead fs-5">
                            ...
                            Jadikan pencapaian rekan kerja kita sebagai tantangan bagi kita untuk melampauinya.
                            Jangan pernah merasa puas dengan apa yang kita miliki saat ini.
                            Jadilah anggota yang memiliki wibawa dan rasa peduli satu sama lain. 
            ...
            <!-- Form Section -->
            <div class="col-lg-6">
                <form action="users_action.php?action=add" method="post" class="form-container" id="roomForm">
                    ...
                    <div class="mb-4">
                        <label for="name" class="form-label">
                            <i class="fa-solid fa-users-rays"></i>Nama Pengguna
                        </label>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            <label for="email" class="form-label">
                                <i class="fa-solid fa-envelope"></i>Email Pengguna
                            </label>
                            <input type="email" class="form-control" id="capacity" name="email" required>
                        </div>
                        <div class="col-md-6">
                            <label for="password" class="form-label">
                                <i class="fa-solid fa-lock"></i>Password
                            </label>
                            <input type="password" class="form-control" id="total_price" name="password" required>
                        </div>
                    </div>

                    <div class="mb-4">
                        <label for="role" class="form-label">
                            <i class="fas fa-info-circle"></i>Role Pengguna
                        </label>
